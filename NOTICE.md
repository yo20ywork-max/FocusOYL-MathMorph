...
FocusOYL MathMorph is a research code and documentation project associated with the experimental FocusOYL Prism-1B release.

The upstream language model is **MiniCPM5-1B by OpenBMB**. Model ancestry, original licenses, and applicable notices are retained. The released Prism file is a derivative weight-editing experiment, not an independently pretrained foundation model, and no upstream endorsement is implied.

This archive uses or depends on established mathematical methods and external software, including NumPy, GGUF tooling, llama.cpp, Hugging Face libraries, and EleutherAI lm-evaluation-harness. Their own licenses apply; dependency distributions are not included. Preserve any copyright and attribution statements already present in archived code.
